...
namespace NNPPoly
{
    public partial class frmActivation : Form
    {
        ...
        private void btnGO_Click(object sender, EventArgs e)
        {
            ...
            Uri uri = new Uri("http://update.wcodez.com/activation.php?uid=" + Properties.Resources.uid + "&name=" + name + "&key=" + key);
            if (isControl)
        ...
        void wc_DownloadStringCompleted(object sender, DownloadStringCompletedEventArgs e)
        {
            ...
            else
            {
                ...
                if (data.ToLower().Equals(txtName.Text.Trim().ToLower() + " "))
                {
                    try
                    {
                        StreamWriter sw = new StreamWriter(File.Open(Job.ACTIVATION_FILE, FileMode.Create));
                        ...
                        Job.Log("Activation error", excep);
                        Suc = false;
                    }
                }
            }
